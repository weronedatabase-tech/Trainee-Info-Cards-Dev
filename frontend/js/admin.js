...
async function handleSavePasswords() {
 // Automatically trim invisible whitespaces from inputs
 const p = {
   'Regular Volunteer': document.getElementById('set-regPass').value.trim(),
   'Adhoc Volunteer': document.getElementById('set-adhocPass').value.trim(),
   'Settings': document.getElementById('set-adminPass').value.trim()
 };
